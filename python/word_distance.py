@mfunction("distance")
def word_distance(word1=None, word2=None, model=None):
    ...
    if not any(id1):
        ...
        if not any(id2):
            ...
            word_rep1 = word_embedding_weights(id1, mslice[:])
            word_rep2 = word_embedding_weights(id2, mslice[:])
            diff = word_rep1 - word_rep2
            distance = sqrt(sum(diff *elmul* diff))
